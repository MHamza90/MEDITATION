class HabitTrackerModel {
  ...
  HabitTrackerModel({this.success, this.data, this.message});

  HabitTrackerModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null ? new TrackerData.fromJson(json['data']) : null;
