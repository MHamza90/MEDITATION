<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.meditation-cards.index') }}
    @endsection
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="userSearchInput" class="form-control form-control-solid w-250px ps-13"
                            placeholder="Search Meditations Categories" />
                    </div>
                    <!--end::Search-->
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('app-management.meditation-cards.store') }}" method="POST"
                                ...
                                <div class="modal-body px-5 my-7">
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="name">Card
                                                Name</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="description">Card
                                                Description</label>
                                            <!--end::Label-->
                                            ...
                                            <div class="rounded border d-flex flex-column p-10">
                                                ...
                                                <textarea name="description" class="form-control form-control form-control-solid" data-kt-autosize="true"></textarea>
                                            </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="task">CARD
                                                TASK</label>
                                            <!--end::Label-->
                                            <!--begin::solid autosize textarea-->
                                            <div class="rounded border d-flex flex-column p-10">

                                                <textarea name="task" class="form-control form-control form-control-solid" data-kt-autosize="true"></textarea>
                                            </div>
                                            <!--end::solid autosize textarea-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Card Task</th>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('app-management.meditation-cards.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('app-management.meditation-cards.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('app-management.meditation-cards.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
