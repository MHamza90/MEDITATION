<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.user.index') }}
    @endsection
    <!--begin::Content-->
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        <div class="card">
            ...
            <div class="card-body py-4">
                ...
                <div class="table-responsive">
                    @include('pages.apps.admin.user.table.list')
        ...
        <script>
            $(document).ready(function() {
                ...
                function searchUser() {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('app-management.user.search') }}",
                        data: {
                            'search': searchText,
                        },
        ...
        <script type="text/javascript">
            ...
            $(".switch-input").change(function() {
                ...
                $.ajax({
                    url: "{{ route('app-management.user.change.status') }}",
                    type: 'GET',
                    /*dataType: 'json',*/
                    data: {
                        'id': this.id,
