<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.category.index') }}
    @endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('app-management.category.store') }}" method="POST"
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('app-management.category.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('app-management.category.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('app-management.category.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
