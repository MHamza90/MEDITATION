<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.meditation-audio.index') }}
    @endsection
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="userSearchInput" class="form-control form-control-solid w-250px ps-13"
                            placeholder="Search Meditations Audio" />
                    </div>
                    <!--end::Search-->
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Meditations Audios</h2>
                                <!--end::Modal title-->
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('app-management.meditation-audio.store') }}" method="POST"
                                ...
                                <div class="modal-body px-5 my-7">
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="file">Audio
                                                File</label>
                                            <!--end::Label-->
                                        ...
                                        <input type="hidden" name="length" id="durationContainer">
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Audio</th>
                            <th class="min-w-125px">Audio Length</th>
                        ...
                        @isset($data)
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <audio controls>
                                            <source src="{{ asset($item->path) }}" type="audio/mp3">
                                            Your browser does not support the audio element.
                                        </audio>

                                    </td>

                                    <td>{{ $item->length ?? 0 }} sec</td>
                                    <td>{{ $item->category->name ?? '' }} sec</td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('app-management.meditation-audio.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('app-management.meditation-audio.edit', $item->id) }}"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (!fileInput) {
                    console.error('Input element with name "path" not found.');
                    return;
                }
                ...
                fileInput.addEventListener('change', function() {
                    ...
                    audioElement.addEventListener('loadedmetadata', function() {
                        var durationInSeconds = audioElement.duration.toFixed(2);
                        // alert(durationInSeconds);
                        document.getElementById('durationContainer').value = durationInSeconds;
                    });
                });
            });
        </script>
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('app-management.meditation-audio.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
