<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.mood.index') }}
    @endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Emotions</h2>
                                <!--end::Modal title-->
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('app-management.mood.store') }}" method="POST"
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Enter Emotions Name" />
                                            <!--end::Input-->
                                        </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('app-management.mood.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('app-management.mood.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('app-management.mood.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
