    ...
    @section('breadcrumbs')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('app-management.mood.index') }}">Emotions</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Edit Emotions</li>
            </ol>
        </nav>
    @endsection
        {{-- @dd($data) --}}
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <h2 class="fw-bold">Edit Emotions</h2>
                    </div>
                </div>
                <!--end::Card header-->
                ...
                <div class="card-body py-4 mx-20">
                    <!--begin::Form-->
                    <form action="{{ route('app-management.mood.update', $data->id ?? '') }}" method="POST"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="Enter Emotions" value="{{ $data->name ?? '' }}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <div class="fv-row mb-7">
