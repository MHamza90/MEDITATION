    ...
    @section('breadcrumbs')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('app-management.slider.index') }}">Slider Management</a></li>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body py-4 mx-20">
                    <!--begin::Form-->
                    <form action="{{ route('app-management.slider.update', $data->id??'') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Title" value="{{ $data->title??'' }}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
