<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.products.index') }}
    @endsection
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('app-management.products.store') }}" method="POST"
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea name="description" id="editor" class="editor form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Enter Description"></textarea><!--end::Input-->
                                        </div>
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" for="profit_per">Profit
                                                Percentage</label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <input type="number" name="profit_per" id="profit_per"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Enter Profit Percentage" step="0.01" min="0" max="100"/>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="date"> Availability
                                                Date</label>
                                            <!--end::Label-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Profit On Product %</th>
                            <th class="min-w-125px">Quantity</th>
                            <th class="min-w-125px">Till Date</th>
                            @can('write product management')
                                <th class="min-w-125px">Status</th>
                            @endcan
                            @can('read review')
                                <th class="min-w-125px">Reviews</th>
                            @endcan
                            @canany(['write product management', 'delete product management'])
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @endcan
                                @can('read review')
                                    <td><a class="menu-link" href="{{ route('app-management.review.list', $item->id) }}">
                                            <span class="menu-icon">{!! getIcon('notification-status', 'fs-2') !!}</span>
                                            <span class="menu-title"></span>
                                        </a></td>
                                @endcan
                                <td class="text-end">
                                    @can('delete product management')
                                        <form action="{{ route('app-management.products.destroy', $item->id) }}"
                                    ...
                                    @endcan
                                    @can('write product management')
                                        <form action="{{ route('app-management.products.edit', $item->id) }}"
    ...
    <script type="text/javascript">
        ...
        $(".switch-input").change(function() {
            ...
            if (this.checked)
                ...
                var status = 0;
            $.ajax({
                url: "{{ route('app-management.product.change.status') }}",
                type: 'GET',
                /*dataType: 'json',*/
                data: {
                    'id': this.id,
