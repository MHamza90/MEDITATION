                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['total_price'] ?? 0 }}
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['profit_per'] ?? 0 }}
                                            data-kt-countup-decimal-places="2"
                                            >
                                            0
                                        </div>
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['total_profit'] ?? 0 }}
                                            data-kt-countup-decimal-places="2"
                                            data-kt-countup-prefix="$">
                                            0
                                        </div>
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['qty'] ?? 0 }}
                                             >
                                            0
                                        </div>
                                    </div>
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['unit_profit'] ?? 0 }}
                                            data-kt-countup-decimal-places="2"
                                            data-kt-countup-prefix="$">
                                            0
                                        </div>
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bold" data-kt-countup="true"
                                            data-kt-countup-value={{ $item['commission']['result'] ?? 0 }}
                                            data-kt-countup-decimal-places="2"
                                            data-kt-countup-prefix="$">
                                            0
                                        </div>
