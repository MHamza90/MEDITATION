<x-default-layout>
    ...
    @section('title')
    Product Limiter Management
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('app-management.product-limiter.index') }}
    @endsection
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="userSearchInput" class="form-control form-control-solid w-250px ps-13"
                            placeholder="Search Product Limiter" />
                    </div>
                    <!--end::Search-->
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('app-management.product-limiter.store') }}" method="POST"
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Product Limiter</h2>
                                <!--end::Modal title-->
                                ...
                                <form id="kt_modal_add_user_form" class="form"
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="max_amount">MAX</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="min_amount">MIN</label>
                                            <!--end::Label-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            @can('write product limiter')
                            <th class="min-w-125px">Status</th>
                            @endcan
                            @canany(['write product limiter', 'delete product limiter'])
                        ...
                        @isset($data)
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    @endcan
                                    <td class="text-end">
                                        @can('delete product limiter')
                                        <form action="{{ route('app-management.product-limiter.destroy', $item->id) }}" method="post" style="display:inline">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        @endcan
                                        @can('write product limiter')
                                        <form action="{{ route('app-management.product-limiter.edit', $item->id) }}" method="get"
    ...
    <script type="text/javascript">
        ...
        $(".switch-input").change(function() {
            ...
            if (this.checked)
                ...
                var status = 0;
            $.ajax({
                url: "{{ route('app-management.product-limiter.change.status') }}",
                type: 'GET',
                /*dataType: 'json',*/
                data: {
                    'id': this.id,
