...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('logos/default-dark.svg') }}" class="h-65px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/default-small.svg') }}" class="h-30px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
