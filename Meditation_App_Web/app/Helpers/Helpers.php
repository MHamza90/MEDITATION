...
if (!function_exists('sendNotification')) {
    function sendNotification($notification)
    {
        ...
        // $recipient = App\Models\User::where('role_id','admin')->first();
        $recipient = "dWlLMTX8nQzag-Wagj1lGT:APA91bGkzMoSDIyNUfjJtjHiDv_-EfHbJhflOm2CAYGVId9TJCkN0Qmh0NbeX1NMk5HIqVSA6F0--j2LRY15R5QcBs7kyHaAgLDIltdmi9mb6Vth0QadFIkZnXj_hneaGyrWJmDTh2vB";
        $serverKey = "AAAAHYivrc4:APA91bEkOROwemJq81NgXdfTdLIg98zpkNuIXO2lzVOgcYXCWHvUKidILQvFU7GYrJlGFIZ_16zuM5uVyO-30nzubwH31zMTX2C99JzHk2KxFOPVG19_SbOf0qy6O_M2VO1oxvgLXQXk";
    ...
    function sendVerificationMail($otp,$email)
    {
        // Send Email
            Illuminate\Support\Facades\Mail::send('emails.reset-password-email', ['otp' => $otp], function($message) use($email){
                $message->to($email, 'Verification Code From PEB Express');
